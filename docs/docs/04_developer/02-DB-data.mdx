...
構造自体は[schema.ts](https://github.com/kazutan1230/robopo/blob/main/app/lib/db/schema.ts)に定義している。
...
- 関連ファイル
  - [/app/api/player/route.ts](https://github.com/kazutan1230/robopo/blob/main/app/api/player/route.ts)
...
- [url]/course/edit で編集
- field, mission, point に入るデータについては別の章で解説する。
  {/* - field, mission, point に入るデータについては[別の章](./03-course-and-mission.mdx)で解説する。 */}
...
**4 Create tables**の`schema.ts`は[`schema.ts`](https://github.com/kazutan1230/robopo/blob/main/app/lib/db/schema.ts)を使う。
...
入れるクエリは[insertIpponBashiCourse.sql](https://github.com/kazutan1230/robopo/blob/main/app/lib/db/queries/insertIpponBashiCourse.sql)と[insertSensorCourse.sql](https://github.com/kazutan1230/robopo/blob/main/app/lib/db/queries/insertSensorCourse.sql)
