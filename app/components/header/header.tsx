    ...
    <>
      <header className="flex flex-row h-24 md:h-14 items-center relative">
        ...
        <div className="hidden lg:inline-block ml-auto">
          {session ? <button onClick={() => signOut({ redirect: true, callbackUrl: "/" })} className="btn btn-primary p-2 text-xl">Sign out</button> : <Link href="/signIn" className="btn btn-primary p-2 text-xl">Sign in</Link>}
